...
export default function DetalhesPagarScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Modal Customizado: Confirmação de Pagamento */}
      <Modal
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalSubtitle}>Quando esta conta foi paga?</Text>
            ...
            <TouchableOpacity
              ...
              accessibilityRole="button"
              accessibilityLabel="Selecionar data de pagamento"
            >
